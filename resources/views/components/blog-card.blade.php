...
<a href="/blogs/{{$blog->slug}}" class="text-decoration-none">
    ...
    <a class="text-white" href="/?category={{$category->slug}}{{request('search')
    ...
    <a href="/blogs/{{$blog->slug}}">
        <div style="position: relative;" class="mt-2">
            <img src="/storage/{{$blog->image}}" class="rounded" style="width:400px;height:300px;object-fit:cover;" alt="blog picture">
